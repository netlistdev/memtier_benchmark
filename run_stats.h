...
public:
    ...
    void update_get_op(struct timeval* ts, unsigned int bytes_rx, unsigned int bytes_tx, unsigned int latency, const char* readable_id, unsigned int hits, unsigned int misses);
    void update_set_op(struct timeval* ts, unsigned int bytes_rx, unsigned int bytes_tx, unsigned int latency, const char* readable_id);

    void update_moved_get_op(struct timeval* ts, unsigned int bytes_rx, unsigned int bytes_tx, unsigned int latency, const char* readable_id);
    void update_moved_set_op(struct timeval* ts, unsigned int bytes_rx, unsigned int bytes_tx, unsigned int latency, const char* readable_id);
    void update_moved_arbitrary_op(struct timeval *ts, unsigned int bytes_rx, unsigned int bytes_tx,
                             unsigned int latency, const char* readable_id, size_t arbitrary_index);

    void update_ask_get_op(struct timeval* ts, unsigned int bytes_rx, unsigned int bytes_tx, unsigned int latency, const char* readable_id);
    void update_ask_set_op(struct timeval* ts, unsigned int bytes_rx, unsigned int bytes_tx, unsigned int latency, const char* readable_id);
    void update_ask_arbitrary_op(struct timeval *ts, unsigned int bytes_rx, unsigned int bytes_tx,
                                   unsigned int latency, const char* readable_id, size_t arbitrary_index);

    void update_wait_op(struct timeval* ts, unsigned int latency, const char* readable_id);
